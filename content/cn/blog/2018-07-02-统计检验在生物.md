...
```
引用：<br>
[参考1：Why we recommend you do not use the Newman-Keuls multiple comparison test](https://www.graphpad.com/support/faq/why-we-recommend-you-do-not-use-the-newman-keuls-multiple-comparison-test/);[参考2：Newman-Keuls Test and Tukey Test](https://www.utdallas.edu/~herve/abdi-NewmanKeuls2010-pretty.pdf);[参考3：SNK.test: Student-Newman-Keuls (SNK) in R](https://rdrr.io/cran/agricolae/man/SNK.test.html)；[参考4：](https://www.uvm.edu/~dhowell/gradstat/psych341/lectures/AnovaReviewFolder/class2.html)
